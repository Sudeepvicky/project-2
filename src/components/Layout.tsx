  ...
  return (
        <div className={`p-2 ${isDarkMode ? 'dark bg-black' : 'bg-gray-100'}`}>
          ...
          >
            ...
            {/* Footer Section */}
            <div className="bg-gray-100 dark:bg-black text-center py-1 dark:text-white text-black dark:bg-gray-900">
              © {new Date().getFullYear()} Battu Sudeep. All rights reserved.
